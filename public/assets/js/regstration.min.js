...
$(document).ready(function () {
  ...
  function setProgressColor(color) {
    $('#progress_bar').removeClass().addClass("progress-bar progress-bar-".concat(color));
  }
